""" Code to fine-tune hugging-face implementation of RoBerta model.
...
from transformers import RobertaForQuestionAnswering, AdamW, RobertaConfig, get_linear_schedule_with_warmup
from transformers import RobertaForNextSentencePrediction, RobertaForSequenceClassification, RobertaForTokenClassification
from transformers import RobertaTokenizer, RobertaModel, RobertaForPreTraining, RobertaForMaskedLM, WEIGHTS_NAME, CONFIG_NAME
...
if __name__=='__main__':
    ...
    parser = argparse.ArgumentParser(description="Fine-tune a RoBerta model for a specific NLP task.")
    ...
    logging.info("Fetching pre-trained RoBerta model: {} and Tokenizer: {} for the task: {}...".format(parameters['pretrained_model'],
    ...
    tokenizer = RobertaTokenizer.from_pretrained(parameters['pretrained_tokenizer'])
    model.to(device)
    logging.info("\tDone.")
