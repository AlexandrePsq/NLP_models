"""
General Language Model based on DISTILBERT architecture.
The model can implement either:
    - DISTILBERT-base,
    - DISTILBERT-large,
    - or a pre-trained DISTILBERT architecture.
...
import utils
from modeling_hacked_distilbert import DistilBertModel


class DistilBertExtractor(object):
    """Container module for DistilBert."""

    def __init__(
        self, 
        pretrained_distilbert_model, 
        language, 
        name, 
        prediction_type, 
        ...
        super(DistilBertExtractor, self).__init__()
        # Load pre-trained model tokenizer (vocabulary)
        # Crucially, do not do basic tokenization; PTB is tokenized. Just do wordpiece tokenization.
        self.model = DistilBertModel.from_pretrained(pretrained_distilbert_model, output_hidden_states=output_hidden_states, output_attentions=output_attentions)
        self.tokenizer = AutoTokenizer.from_pretrained(pretrained_distilbert_model)
        
        self.language = language
        self.pretrained_distilbert_model = pretrained_distilbert_model
    ...
    def __name__(self):
        """ Retrieve DistilBert instance name."""
        return self.name
