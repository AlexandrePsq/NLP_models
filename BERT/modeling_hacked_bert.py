# coding=utf-8
# Script derived from the hugging-face modeling_bert.py
"""PyTorch BERT model. """
...
class BertAttention(nn.Module):
    ...
    def forward(
        ...
        outputs = (attention_output,) + self_outputs # we add to the output of Attention the "context_layer", 
        # which is the matmul between the attention heads and "value_layer" (original line above)
        return outputs
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layer):
            ...
            if self.output_attentions:
                ...
                all_attentions = all_attentions + (layer_outputs[1:],) # original line above
